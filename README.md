...
| 48 | `sast` | SAST integration with SARIF parsing (Semgrep, Trivy, Bearer) |
...
| Research and reporting | `osint`, `vuln-intel`, `auto-research`, `standard-catalog`, `reporting`, `enrichment`, `program-memory`, `scope-manager`, `triage-validation` |
